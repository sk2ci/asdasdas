...
module.exports.run = async (bot, message) => {
  ...
  const embed = new Discord.RichEmbed()
    ...
    .addField(`Destek Sunucusu`, `https://discordapp.com/oauth2/authorize?client_id=691575731658162217&scope=bot&permissions=8`, false)
    .addField(`Botu Ekleyin`, `https://discord.gg/TDRpkDv`, false)
  .addField(`Bota Oy Verin`, `YAKINDA.`, false)
